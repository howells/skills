...
- **Every brief ends with the report format.** What landed, files touched, gates pass/fail, anything that contradicted the spec. Under ~10 lines. No narrative, no restating the spec back, no summary of what it read, no options-and-trade-offs essay. Say you'll ask for depth when you want it.
