...
|------|---------|-----------|----------|
| Söhne | Klim | Quiet confidence, precision, excellent at all sizes | Premium products, understated brands, the modern workhorse |
| Founders Grotesk | Klim | Tight, slightly condensed, newspaper energy | Editorial products, publishing tools, density with class |
| GT America | Grilli Type | Bridges American gothic and European grotesk | Professional products that want authority without coldness |
...
| ↳ *always as **InterVariable*** | rsms.me/inter | The canonical variable build: `opsz` axis + full cv/ss OpenType feature set (CDN builds strip some). Self-host via `next/font/local` | See [typography-opentype.md](typography-opentype.md) § Character Variants for feature selection |
...
| Outfit | Rodrigo Fuenzalida | Clean geometric with a wide x-height | Modern consumer, friendly products |
| Figtree | Erik Kennedy | Warm geometric with open apertures, genuine Inter alternative | Brands wanting differentiation from Inter without sacrifice |
| Familjen Grotesk | Familjen STHLM | Modern editorial grotesque, subtle personality in terminals | Editorial, cultural, studio brands |
| Onest | onest.md | Clean geometric, friendly proportions, crisp on screen | Fresh professional brands |
| Libre Franklin | Impallari Type | Faithful Franklin Gothic, 18 styles. A proper neo-grotesque | Products that want traditional authority. Criminally underused |
...
|------|---------|-----------|----------|
| General Sans | ITF Free Font License | Minimal, clean presence | UI + tech, brands wanting clarity with presence |
| Satoshi | ITF Free Font License | Modern geometric, friendly | Consumer apps, modern brands |
| Switzer | ITF Free Font License | Modern grotesque, editorial | Editorial products, professional brands |

### Mono

| Font | Source | Character | Good for |
|------|--------|-----------|----------|
| Söhne Mono | Klim (commercial) | Clean, modern, pairs perfectly with Söhne | Developer tools, code blocks, data-adjacent UI |
| Pitch | Klim (commercial) | Typewriter character without nostalgia | Creative tools, writing apps, "made by hand" feel |
| ABC Repro Mono | Dinamo (commercial) | Industrial, slightly brutalist | Technical brands, dev infrastructure, raw honesty |
| Basis Grotesque Mono | Colophon (commercial) | Quiet, unobtrusive, clean | When mono needs to be present but not the star |
| Geist Mono | Google Fonts | Clean, modern, pairs with Geist sans | Developer tools, code blocks, data UI |
| JetBrains Mono | Google Fonts | Ligatures, designed for code, excellent readability | IDE-adjacent products, technical brands |
| IBM Plex Mono | Google Fonts | Part of Plex superfamily, clean, institutional | Technical documentation, enterprise products |

---

## Brand / Display Fonts

Fonts that express. They carry personality in headlines, hero text, wordmarks, and anywhere the brand speaks with its own voice. A brand font should say something about who you are.
...
| Font | Designer/Foundry | Character | Good for |
|------|-----------------|-----------|----------|
| Newsreader | Production Type (Jean-Baptiste Levée) | 42 styles, 3 optical sizes. Elegant, sturdy, contemporary | Publishing, journalism, serious tools, long-form reading |
...
### Display (headlines and hero moments)
...
- **Validate with evidence.** Search fontsinuse.com and typewolf.com for your chosen fonts before committing. See how they pair, what sizes they work at, and what contexts they thrive in.
...
These combinations are validated in real shipped projects:

| Display / Heading | Body / UI | Mood |
|-------------------|-----------|------|
| Lyon Text | Söhne | Editorial authority, personal, premium |
| Novarese | Söhne + Geist Mono | Warm craft + modern precision |
| Signifier | Inter + Geist Mono | Contemporary editorial, tech-meets-print |
| Newsreader | DM Sans | Elegant long-form reading, approachable |
| Hedvig Letters Serif | Hedvig Letters Sans | Warm Swedish coherence, editorial |
| Barlow Condensed | DM Sans | Bold display energy + clean body |
| Fraunces | DM Sans | Craft warmth + geometric clarity |
| Martina Plantijn | Söhne + JetBrains Mono | Humanist warmth + Swiss UI precision |
| Cormorant Upright | Geist + Geist Mono | Classical elegance + modern system |
| Hedvig Letters Serif | Inter + Geist Mono | Editorial accent in a modern interface |
| GT Sectra | Söhne | Sharp editorial + quiet authority |
| Canela | Akkurat | Ethereal luxury + Swiss precision |
| Tiempos Headline | Founders Grotesk | Premium magazine feel |
